...
A tidy_table data table is created with the mean and standard deviation of each measurement calculated by activity and subject. This is output to tidy_data.txt. The clean data output file.
